            ...
            <div class="col s12">
              <div class="card">
                <div class="card-image">
                  ...
                  <a
                    href="/repos/portfolio-website/projects/tictactoe/index.html"
      ...
      <div class="container">
        <div class="row">
          <div class="col l6 s12">
            ...
            <p class="white-text">
              (815) 742-1496<br />
              <a href="mailto:caderosche@gmail.com" class="white-text"
                >caderosche@gmail.com</a
              >
            </p>
            <!--start contact form-->
              ...
              <form class="col s12">
                <div class="row">
                  <div class="input-field col s6">
                    ...
                    <label for="first_name" class="white-text"
                      >First Name</label
                    >
                  </div>
                  <div class="input-field col s6">
                ...
                <div class="row">
                  <div class="col s12">
                    <button
                      class="btn waves-effect waves-dark white black-text"
                      type="submit"
                      name="action"
                    >
                      Send Message
          ...
          <div class="col l3 s12">
            ...
            <ul>
              <li>
                <a
                  class="white-text"
                  href="https://www.linkedin.com/in/cade-rosche-5263b1a0/"
                  >LinkedIn</a
                >
              </li>
